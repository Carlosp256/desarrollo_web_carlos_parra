...
- La base de datos incluye 15 miembros de prueba con correos `@dcc.uchile.cl` e `@ing.uchile.cl`, 30 actividades (2 por miembro) cubriendo todos los tipos y días de la semana, y 60 fotos asociadas.